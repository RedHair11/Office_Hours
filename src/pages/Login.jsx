    ...
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        ...
        {state === 'Sign Up'
          ? <div className='w-full'>
              <p>Student ID</p>
              <input onChange={(e) => setStudentID(e.target.value)} value={studentID} className='border border-zinc-300 rounded w-full p-2 mt-1' type="text" required />
            </div>
          : null
        }
        ...
        {state === 'Sign Up'
          ? <div className='w-full'>
              <p>Major</p>
              <input onChange={(e) => setMajor(e.target.value)} value={major} className='border border-zinc-300 rounded w-full p-2 mt-1' type="text" required />
            </div>
          : null
        }
